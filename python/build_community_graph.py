...
citation_data.groupby(['paper_venue', 'reference_venue', 'paper_community', 'reference_community', 'year']).size().reset_index().to_csv('graphs/grouped_data.csv', index = False)
